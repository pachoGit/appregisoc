...
fun PhysicalTrainerEditScreen(
    ...
    FormScaffold(
        title = "Editar Preparador Físico",
        onCancel = onCancel,
        onSave = {
...
@Preview
@Composable
private fun PhysicalTrainerEditScreenPreview() {
    MaterialTheme {
        PhysicalTrainerEditScreen(
            entity = PhysicalTrainerResponse(id = 1, clubId = 1, firstName = "Carlos", lastName = "López", documentNumber = "12345678", age = 35, dateOfBirth = "1990-03-10"),
            onSave = {},
            onCancel = {}
        )
    }
