...
fun PhysicalTrainerCreateScreen(
    ...
    FormScaffold(
        title = "Registrar Preparador Físico",
        onCancel = onCancel,
        onSave = {
            val validation = PhysicalTrainerValidator.validate(
...
@Preview
@Composable
private fun PhysicalTrainerCreateScreenPreview() {
    MaterialTheme { PhysicalTrainerCreateScreen(onSave = {}, onCancel = {}) }
}
